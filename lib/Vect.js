...
class Vect2 {
   ...
   * @param {Array} xs - the coordinates of the `Vect2`.  Can be a
   * `Float64Array` or plain `Array`.
...
class Vect4 {
   ...
   * @param {Array} xs - the coordinates of the `Vect4`.  Can be a
   * `Float64Array` or plain `Array`.
   ...
   * @type {number}
   */
  get w() { return this._arr[3]; }
  set w(a) { this._arr[3] = a; }
  get 3() { return this._arr[3]; }
  set 3(a) { this._arr[3] = a; }
